...
const sections = [
    {
        ...
        tags: [
            ...
            'Log File Parsing and Ingestion',
        ],
    },
    {
        ...
        tags: [
            'Intrusion Detection and Risk Assessment',
    ...
    },
    {
        ...
        tags: [
            ...
            'Model Retraining for Emerging Threats',
...
const ModelDesign = () => {
    ...
    return (
        <div className="container flex flex-col justify-center items-center">
            <h1 className="text-4xl font-black my-3 mb-12 w-1/2 leading-10 text-center pl-8 font-jost animate-scale">
                State-of-the-Art AI-Powered Cyber Forensics Engine
            </h1>
            <div
                ref={containerRef}
                className="h-full container flex flex-col md:flex-row overflow-hidden animate-scale"
            >
                    ...
                    {sections.map((section, index) => (
                        <motion.div
                            ...
                            className={`text-[15.5px] p-4 py-1 font-semibold mb-4 cursor-pointer transition-all border border-solid duration-300 rounded-full ${
                                index === activeIndex
                                    ? 'bg-accent/30 border-accent-foreground text-foreground'
